...
text_FAT12_isboot	equ 1			; Bootable? = 1, else 0. It's needed for boot option, otherwise it will be a data disk.
text_FAT12_markup	equ 1			; Make BPB markup? = 1, else 0. It's needed for detectable FAT12
...
FAT12_generation_result:
	if text_FAT12_markup eq 1
		db 0xEB, 0x3C, 0x90
